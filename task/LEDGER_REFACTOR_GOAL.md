...
⑥ «두 번째 온톨로지 선언»이 없다   ledger_config.json 하나가 «온톨로지»의 전부다
     ...
     흡수 대상은 «하나»: mechanism_models.json
     🔴 2026-08-28 13:0x 정정 — finding_kinds.json 은 «흡수 대상이 아니다»:
        method 는 이미 원자 안(run_uid 접두 sat, 103,841/103,841)이고,
        나머지 칸은 물리(표·컬럼)이며, 제품 소비자가 «0»(호출자 전부 seed 스크립트)이다
        -> 흡수가 아니라 «쓰는 쪽 옆으로 이동»
