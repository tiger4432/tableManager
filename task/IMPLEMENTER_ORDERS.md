...
# 🔴 라운드 3 «수락 조건 교체» — 소유자 지시. 이게 A 의 진짜 시험입니다 (총괄 21:2x)
...
# 🔴 소유자 지시 «v1 은퇴 바로» — 라운드 2를 «끝내고» 곧장 갑니다 (총괄 21:1x)
...
✅ 맞는 것   API 가 {kind, label, sublabel, detail, color_role} 을 «주고»
...
🔴 가짜 응답의 «모양»은 지어내지 말고 실측에서 뜨십시오:
   후보 = subgraph 응답의 ranked 항목 모양 + {kind, label, sublabel, detail, color_role}
