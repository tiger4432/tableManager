...
> - ⚠️ **`map_editor2.html:856`의 확정 문구는 아직 정확히 두 개의 키 값(`data-me2-confirm-eqp`/`-product`)을 전제합니다** — 위 수정으로 arity 1/3 룰의 확정이 처음으로 도달 가능해졌는데 문구는 아직 안 바뀌었습니다. 총괄 판정 대기(`3d43a6c` 커밋 본문).
>
