...
| 🆕㈤ | `chain/rule_order` | 4,240 | 2026-09-13 | The order rules run in, DERIVED from the declaration rather than declared (S-156 `c7bc59db`). The worker reads it; `chain/replay` delegates to it. The self-edge exception is a PROPERTY of the pair, never a name (S-232 `c70dc340`, 판정 387 · S-232-b `684ffb4d`, 판정 388). |
