...
# D-9. 🔵 문법 동결 문장 — **정본** (2026-09-09 19:2x, 판정 196·197·198·199 뒤)
...
방향 ②  🔴 «하나»  select(「이 분자가 이 문장을 말하나」) = **S-99**. 그 밖의 다섯 인자는 전부 칸이 있다
                 read ① · filter ①(S-91) · unit ① · emit ①(t ① · 다중 ① · 정의역 ② · 부재 ②)
                 규칙의 «명시된 예외» registration_probe ① (비국소성이 칸으로 이미 표현돼 있다)

=> **2026-09-09 19:2x 기준: 번역 인자의 ③ = «1». S-99 가 닫히면 «0» 이고, 그 0 은 공허하지 않다**
