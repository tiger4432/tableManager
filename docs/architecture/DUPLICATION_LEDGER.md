...
> **Status:** 🟢 Living | **Last-verified:** 2026-07-31 | **Owner:** 전 에이전트 공용 · **유지: doc-keeper** | **Source-of-truth:** 각 항목의 「몇 곳」 — 전부 grep 실측
>
...
- **몇 곳 (2, 실측)**: `map_overlay.py:184`(**THE 조립기** — `identity_cols, values, binding`) · `map_meta_registrar.py:132`(`key_columns, row, table_name`).
