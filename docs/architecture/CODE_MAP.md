...
`execute_scoped_batch(snapshot, source_id, base_rows, scope, join_reader, preparers, mappers, store, *, known_registrations=None) -> CursorBatchExecutionResult`
