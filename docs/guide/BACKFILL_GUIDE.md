...
> **Status:** 🟢 Living | **작성:** 2026-07-31 · doc-keeper | **Last-verified:** 2026-09-02 (§7.6 페이싱 — `pace` 를 든 연산이 **하나에서 둘로**(`chain_replay` 합류), 읽는 쪽은 **둘에서 셋으로**, 모르는 이름의 갈림은 「둘이 다르다」가 아니라 **2 대 1**) · 직전 2026-08-31
>
