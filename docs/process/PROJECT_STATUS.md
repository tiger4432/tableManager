...
1. **🔴 M2-v2 「계획 = 그 맵 자체」 재설계 — 최우선, 구현 진행 중(2026-07-26 저녁)**
   ...
   **⏱️ 병합 관문 현황 (2026-07-26 21시 갱신)**
   ...
   - **다음 순서**: 오버레이 일원화 수령·검수 → `.sample` config 정정 + `test_map_presets_api` 격리 수령(목표 **414 passed / 0 failed**) → 병합.
