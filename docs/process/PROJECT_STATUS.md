...
>
> 🔴 **대기 중인 검수**: 오리진 정합 3건은 **T1** — QA 2레인 + 감사 미실시. 브라우저 E2E·`dist` 빌드도 미실시(하네스 vm 채점만)
>
