...
> **Status:** 🟢 Living | **Last-verified:** 2026-08-13 (**§P2 인제션에 tier-1 끌어올리기 5항** — `831ab68`. 🔴 **콜드 스윕 대조군 없이 초록으로 읽지 말 것** · 🔴 **걸러진 파일도 «이동»은 갚아야 한다**(회귀가 난 자리). **드리프트 부팅 점검에 자기 수리 5항** — `eb700e5`. 🔴 **시스템 테이블은 강등되지 않는다**가 대조 항목이고, **타입 불일치가 안 잡히는 것은 정상**이다) | **Owner:** Integrity/QA | 갱신 **doc-keeper 전담** · 정합 감사 **doc-auditor**
>
