...
> **Status:** 🟢 Living | **Last-verified:** 2026-08-17 Ledger v2 1·2단계 승인; 3단계 config-only Registry·immutable snapshot `STAGE_3_IN_REVIEW` / `NOT_APPROVED`
> 
