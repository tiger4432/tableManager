...
| `enrichment_rules.json` | Enrichment Queue 규칙(결손 보정 + dedup 체인 룰 자동 파생, 선택적 `claim_contract`는 결손 공급 계약. 🔴 **[2026-08-28] `Enrich Action`은 walk의 노드가 아니게 됐다** — 이 선언의 나머지는 그대로다) |
