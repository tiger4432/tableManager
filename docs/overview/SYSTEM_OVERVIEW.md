...
> **Status:** 🟢 Living | **Last-verified:** 2026-08-18 Ontology Config Explorer `COMPLETE / APPROVED` (`2d1ad863`)
> 
...
| **정준 원장(ledger) — 개체·주장·원천 사건의 정본** | 작성 순서 [ONTOLOGY_LEDGER_SETUP](../guide/ONTOLOGY_LEDGER_SETUP.md) · 실행 경계 [LedgerFrame Chain Mapper](../architecture/LEDGER_FRAME_CHAIN_MAPPER.md) · 재설계 [Ledger v2 Plan](../../ledger_v2_redesign_plan_20260817/README.md) · **1단계 실측 [Inventory](../../ledger_v2_redesign_plan_20260817/HARDCODING_INVENTORY.md) / [Call Graph](../../ledger_v2_redesign_plan_20260817/CURRENT_CALL_GRAPH.md) / [Baseline](../../ledger_v2_redesign_plan_20260817/BASELINE_RESULTS.md)** · **2단계 근거 [Acceptance Evidence](../../ledger_v2_redesign_plan_20260817/STAGE_2_ACCEPTANCE_EVIDENCE.md)** · **3단계 근거 [Registry Evidence](../../ledger_v2_redesign_plan_20260817/STAGE_3_ACCEPTANCE_EVIDENCE.md)** · **4단계 근거 [RoleFrame Evidence](../../ledger_v2_redesign_plan_20260817/STAGE_4_ACCEPTANCE_EVIDENCE.md)** · **5단계 근거 [Source Preparation Evidence](../../ledger_v2_redesign_plan_20260817/STAGE_5_ACCEPTANCE_EVIDENCE.md)** · **6단계 근거 [Parity/PG Evidence](../../ledger_v2_redesign_plan_20260817/STAGE_6_ACCEPTANCE_EVIDENCE.md)** · **7단계 근거 [Cutover Evidence](../../ledger_v2_redesign_plan_20260817/STAGE_7_ACCEPTANCE_EVIDENCE.md)** · **목표 구조/정본 [TARGET_ARCHITECTURE_AND_SSOT](../../ledger_v2_redesign_plan_20260817/TARGET_ARCHITECTURE_AND_SSOT.md)** · **Mapper 패턴 [MAPPER_DESIGN_PATTERN](../../ledger_v2_redesign_plan_20260817/MAPPER_DESIGN_PATTERN.md)** · **config 정본 [CONFIG_CANON](../../ledger_v2_redesign_plan_20260817/CONFIG_CANON.md)** · 계약 [LEDGER_TECHNICAL_SPEC](../spec/LEDGER_TECHNICAL_SPEC.md) · [Evidence Subgraph](../spec/LEDGER_EVIDENCE_SUBGRAPH_SPEC.md) · 판정 [LEDGER_RULINGS](../process/LEDGER_RULINGS.md) | `server/ledger/*` — gate/store/cursor/LedgerFrame/read API를 유지한 v2 1~7단계가 승인·main 병합됐다. 🔴 **[2026-08-18] 셋업은 파일 하나(`server/config/ontology/ledger_config.json`)이고 «선언이 곧 활성화»다** — `manifest.json` 다섯 파일 모양과 `mode`/`parity_status` selector, 문법 드라이버 넷이 함께 은퇴했다. 로드 경계는 `server/ledger/setup.py`의 `load_setup`이고 백필 드라이버는 하나다. 🔴 **[2026-08-21] `setup_version: 5` — 소스 하나가 `relation`·`read`·`prepare`·`map`·`bind`를 직접 든다**(위 config 표 참조). 기존 cursor shape/version은 자동 변환하지 않으며 운영 reset·legacy 삭제는 별도 승인 전까지 잠겨 있다. |
