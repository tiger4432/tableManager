...
> **생략**한다(`approval_status`는 필수로 남는다). v2 작성 지침은
> [ONTOLOGY_LEDGER_SETUP §4·§7.6](../guide/ONTOLOGY_LEDGER_SETUP.md)이 정본이다.
