...
- **경합 방지 락킹 (Race Condition Lock)**: 빠른 스크롤 시 API 요청이 다중 예약되는 현상을 방지하기 위해 `_fetch_scheduled` 즉시 락을 사용하여 불필요한 네트워크 스파이크를 원천 차단합니다.
...
---
*AssyManager Ultimate Technical Bible v1.2 | 2026.04.18 (PostgreSQL & GIN Revision)*
