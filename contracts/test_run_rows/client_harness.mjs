/**
 * TEST RUN ROWS — the client half lives in `client2/tests/test_run_rows_harness.mjs`, and this
 * file is the RUNNER that makes `check_contracts.mjs` count it.
 *
 *   node contracts/test_run_rows/client_harness.mjs
 *
 ...
 */
import '../../client2/tests/test_run_rows_harness.mjs';
...
console.error('test_run_rows_harness.mjs returned instead of exiting — it did not run itself. '
