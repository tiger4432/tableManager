/**
 * LEDGER RECEIPT — the client half lives in `client2/tests/ledger_receipt_timeline_harness.mjs`,
 * and this file is the RUNNER that makes `check_contracts.mjs` count it.
 *
 *   node contracts/ledger_receipt/client_harness.mjs
 *
 ...
 */
import '../../client2/tests/ledger_receipt_timeline_harness.mjs';
...
console.error('ledger_receipt_timeline_harness.mjs returned instead of exiting — it did not run '
  + 'itself. Run it directly to see why. Do NOT read this as a passing contract.');
process.exit(2);
